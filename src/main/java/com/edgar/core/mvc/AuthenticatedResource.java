...
public class AuthenticatedResource {
        ...
        public ModelAndView login(@RequestParam("username") String username,
                ...
                return ResponseMessage.asModelAndView(MessageUtils.getMessage("msg.login.success"));
        }
        ...
        public ModelAndView logout() {
                Subject subject = SecurityUtils.getSubject();
                subject.logout();
                return ResponseMessage.asModelAndView(MessageUtils.getMessage("msg.logout.success"));
        }
}
