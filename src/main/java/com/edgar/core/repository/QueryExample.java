...
public class QueryExample {
        ...
        public QueryExample limit(int limit) {
                // Assert.isTrue(limit > -1, "limit必须大于0");
                this.limit = limit;
                return this;
        }
        ...
        public QueryExample offset(int offset) {
                Assert.isTrue(offset >= 0, "offset must be equals or  greate than 0");
                this.offset = offset;
                return this;
        }
        ...
        public QueryExample addField(String field) {
               Assert.hasText(field, "field cannot be null");
        ...
        public QueryExample addFields(List<String> fields) {
                Assert.notEmpty(fields, "field cannot be null");
        ...
        private QueryExample addCriteria(String field, SqlOperator op, Object value1, Object value2) {
                Assert.hasText(field, "field cannot be null");
                Assert.notNull(value1, "value1 cannot be null");
                Assert.notNull(value2, "value2 cannot be null");
