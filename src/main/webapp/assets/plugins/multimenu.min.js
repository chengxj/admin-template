!function (n, i) {
    "use strict";
    var e = i.Modernizr, t = n("body");
    n.DLMenu = function (i, e) {
        this.$el = n(e), this._init(i)
    }, n.DLMenu.defaults = {animationClasses: {classin: "dl-animate-in-1", classout: "dl-animate-out-1"}, onLevelClick: function () {
        return!1
    }, onLinkClick: function () {
        return!1
    }}, n.DLMenu.prototype = {_init: function (i) {
        this.options = n.extend(!0, {}, n.DLMenu.defaults, i), this._config();
        var t = {WebkitAnimation: "webkitAnimationEnd", OAnimation: "oAnimationEnd", msAnimation: "MSAnimationEnd", animation: "animationend"}, s = {WebkitTransition: "webkitTransitionEnd", MozTransition: "transitionend", OTransition: "oTransitionEnd", msTransition: "MSTransitionEnd", transition: "transitionend"};
        ...
        this.$trigger.on("click.dlmenu", function () {
            ...
            var e = n(this), t = e.parents("ul.dl-submenu:first"), s = t.parent(), o = t.clone().insertAfter(i.$menu), a = function () {
                i.$menu.off(i.animEndEventName).removeClass(i.options.animationClasses.classin), o.remove()
            };
            return setTimeout(function () {
                o.addClass(i.options.animationClasses.classout), i.$menu.addClass(i.options.animationClasses.classin), i.supportAnimations ? i.$menu.on(i.animEndEventName, a) : a.call(), s.removeClass("dl-subviewopen");
    ...
    n.fn.dlmenu = function (i) {
        if ("string" == typeof i) {
            ...
            this.each(function () {
                ...
                return t ? n.isFunction(t[i]) && "_" !== i.charAt(0) ? (t[i].apply(t, e), void 0) : (s("no such method '" + i + "' for dlmenu instance"), void 0) : (s("cannot call methods on dlmenu prior to initialization; attempted to call method '" + i + "'"), void 0)
            })
