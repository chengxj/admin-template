function CancelAddCtrl($scope, MessageService, LocationTo) {
    $scope.master = {};
    ...
    $scope.submitIdCardNo = function() {
        if ($scope.idCardNo) {
            ...
            if (idCardNo === '123456') {
                ...
                $scope.customer = {idCardNo : $scope.idCardNo ,email : "zyz@higheasyrd.com", customerName : "UI Demo", mobileNo : "123456", address : "UI Demo Address"}
            }
            /*.UI Demo*/
        }
...
CancelAddCtrl.$inject = [ '$scope', 'MessageService', 'LocationTo'];