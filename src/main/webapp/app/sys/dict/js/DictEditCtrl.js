function DictEditCtrl($scope, DictService, MessageService, LocationTo, $routeParams) {
...
DictEditCtrl.$inject = [ '$scope', 'DictService', 'MessageService', 'LocationTo', '$routeParams'];