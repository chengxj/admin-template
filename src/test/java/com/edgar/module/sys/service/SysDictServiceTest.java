...
import com.edgar.module.sys.service.SysDictServiceImpl;
...
public class SysDictServiceTest {
        ...
        public void testDeleteByPkSuccess() {
                ...
                when(sysDictDao.deleteByPkAndVersion(anyString(), anyLong())).thenReturn(1);
                when(sysDictDao.delete(any(QueryExample.class))).thenReturn(1);
                int result = sysDictService.deleteWithLock(sysDict.getDictCode(), sysDict
