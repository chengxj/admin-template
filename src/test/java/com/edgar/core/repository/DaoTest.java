...
public class DaoTest {
    ...
    public void testQuerySingleColumn() {
        ...
        public void testDeleteByPk() {
                ...
                List<TestTable> testTables = testTableDao.query(example);
                TestTable TestTable = testTables.get(0);
                int result = testTableDao.deleteByPk(TestTable.getTestCode());
        ...
        public void testDeleteByPk2() {
                ...
                pk.setTestCode2(test2Table.getTestCode2());
                pk.setTestId(test2Table.getTestId());
                int result = test2TableDao.deleteByPk(pk);
                Assert.assertEquals(1, result);
                Test2Table getTestTable = test2TableDao.get(pk);
                Assert.assertNull(getTestTable);
        }
        ...
        public void testDeleteByPKAndVersion() {
                ...
                List<TestTable> testTables = testTableDao.query(example);
                TestTable TestTable = testTables.get(0);
                int result = testTableDao.deleteByPkAndVersion(TestTable.getTestCode(), TestTable
